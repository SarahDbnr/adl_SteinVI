...
| **Aspect**                       | **Findings**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Algorithm Performance**        | - **SVGD**: Consistently performed well across different tasks, when using for example the adam optimizer, but it also gets stuck quite easily when using the optax optimizer SGD(). Performs better than random forest most of the time for especially for classification problem, but for example also for the diabetes dataset. <br>- **sSVGD**: Introduced beneficial Noise, but also gets stuck pretty easily, when using the SGD optimizer. Also the Problem arises, that the noise is very small compared to the particle coordinates so the noise does not really effect the training and one just gets the same result as when using svgd with the SGD optimizer. One can get different/better results for sSVGD when we multiply the noise with a constant factor e.g. 1000 when adding the noise in Algorithm 2 "A stochastic Stein Variational Netwon method" by Alex Leviyev et. all.(Here on need to do that manually in the local blackjax file), when using SGD. Also when using for example the adam optimizer as a optimizer for sSVGD one get small differences in the performance compared to using SVGD, but sometimes noise introduces to much uncertainty so that the algorithms does find the optimum. |
...
| **Training Dynamics**            | - Early iterations showed rapid decreases in loss/accuracy, with slower improvements over time.<br>- sSVGD displayed more fluctuations due to stochasticity, especially when using SGD() and a constant factor multiplied to the noise. The fluctuation depends of course strongly on the learning, the decay rate and the transitioning steps                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
