...
import stein_vi.algorithm.plain_SVGD.local_blackjax_file_for_plain_svgd
from stein_vi.algorithm.plain_SVGD.local_blackjax_file_for_plain_svgd import rbf_kernel, update_median_heuristic
...
def initialize_svgd_state(svi):
    ...
    svgd = stein_vi.algorithm.plain_SVGD.local_blackjax_file_for_plain_svgd.as_top_level_api(grad_log_posterior,svi.parameter.learning_rate, rbf_kernel, update_median_heuristic)
