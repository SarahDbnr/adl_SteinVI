...
class Parameter:
    ...
    def __init__(self, optimizer, regression, early_stopping=False, image_data=False, batch_size=0, particle_batch_size=0, num_particles=10, num_iterations=100, handler=Handler()):
