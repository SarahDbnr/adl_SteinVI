...
@pytest.mark.parametrize(
    "current_metrics, expected_best_metrics, expected_patience_counter",
    [
        (10.006, 10.006, 0),
        (10.005, 10.005, 0),
        (10.004, 10, 1),
...
def test_early_stopping_fn(current_metrics, expected_best_metrics, expected_patience_counter,
                           stein_vi_regression_example):
    # given
    best_metrics = 10
    patience_counter = 0
