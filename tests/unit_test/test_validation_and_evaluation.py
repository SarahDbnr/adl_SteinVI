...
def test_get_evaluation_metrics_over_predictions_regression(stein_vi_regression_example, get_regression_toy_example,
                                                            stein_vi_multiclass_example):
    # given
...
def test_get_evaluation_metrics_over_predictions_multiclass(stein_vi_regression_example, get_MNIST,
                                                            stein_vi_multiclass_example):
    # given
...
def test_compute_confidence_intervals_with_2_neurons(stein_vi_regression_example, get_regression_toy_example):
    # given
    z_train, y_train, _, _, _, _ = get_regression_toy_example
