...
def test_apply_data_settings_sklearn_shuffling():
    ...
    # then
    assert not jnp.array_equal(x_train1,
                               x_train3), "Shuffling with different keys should produce different training data"
    assert not jnp.array_equal(y_train1,
                               y_train3), "Shuffling with different keys should produce different training labels"
